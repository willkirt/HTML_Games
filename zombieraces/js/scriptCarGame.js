...
function drawResults(){
    if(zom1Speed +56 > finish && winner ==false){
        //zombie 1 winning condition
        ctx.fillStyle = 'black';
        ctx.font = '30px Syne Tactile';
        ctx.textAlign = 'center';
        ctx.fillText('Zombie Tom made it to the finish line first.\n Zombie Tom WINS!!!', c.width/2,c.height/2);
        winner = true
    }
    else if(zom2Speed +56 > finish && winner == false){
        //zombie 2 win condition
        ctx.fillStyle = 'black';
        ctx.font = '30px Syne Tactile';
        ctx.textAlign = 'center';
        ctx.fillText('Zombie Bob made it to the finish line first.\n Zombie Bob WINS!!!', c.width/2,c.height/2);
        winner = true
    }
        ...
        ctx.font = '30px Syne Tactile';
        ctx.textAlign = 'center';
        ctx.fillText('Zombie ran out of blood.\n Everyone loses :(', c.width/2,c.height/2);
        winner = true
    }
}
